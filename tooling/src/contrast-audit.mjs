...
const TEXT_PAIRS=Object.freeze([
  ...
  {id:'brand-text-on-secondary',foreground:'color-text-brand',background:'color-secondary',min:4.5},
  {id:'destructive-text-on-secondary',foreground:'color-danger-text',background:'color-secondary',min:4.5},
  {id:'on-primary-on-primary',foreground:'color-on-primary',background:'color-primary',min:4.5},
  {id:'on-primary-container-on-primary-container',foreground:'color-on-primary-container',background:'color-primary-container',min:4.5},
  {id:'focus-ring-on-surface',foreground:'color-border-focused',background:'color-surface',min:3},
